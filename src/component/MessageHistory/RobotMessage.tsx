                    ...
                    items={[
                        {
                            ...
                            content: (
                                <Descriptions column={1}>
                                    <Descriptions.Item label="Status">{stepText(item?.status)}</Descriptions.Item>
                                    {item.description && (
                                        <Descriptions.Item label="Question">{item?.description}</Descriptions.Item>
                                    )}
                                    {item.answer && <Descriptions.Item label="Answer">{item.answer}</Descriptions.Item>}
                                </Descriptions>
                            ),
                        },
                    ]}
            ...
            <Bubble
                ...
                content={
                    Array.isArray(props.result) ? (
                        <ContentOrStep result={props.result} status={props.status} />
                    ) : (
                        props.result
                    )
                }
